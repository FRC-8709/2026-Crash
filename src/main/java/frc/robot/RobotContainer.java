...
public class RobotContainer {
    ...
    //Intake Controls
    private final JoystickButton joystickright2Button6 = new JoystickButton(joystickRight2,6);
    ...
    private void configureBindings() {
        ...
        */
        ...
        joystickright2Button6.onTrue(new startRollers(s_IntakeRoller));
        joystickright2Button6.onFalse(new stopRollers(s_IntakeRoller));
