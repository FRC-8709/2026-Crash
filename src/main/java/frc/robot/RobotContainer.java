...
import frc.robot.command.IntakeCommands.startRollersSlow;
...
public class RobotContainer {
        ...
        // Swerve Buttons
        private final JoystickButton joystickLeft1Button5 = new JoystickButton(joystickLeft1, 5);
    ...
    private void configureBindings() {
        ...
        */
        ...
        joystickLeft2Button6.onTrue(Commands.runOnce(() -> s_Shooter.setMotorSpeedRPM(10)).andThen(Commands.runOnce(() -> s_Indexer.setMotorSpeedRPM(13))));
        joystickLeft2Button6.onFalse(Commands.runOnce(() -> s_Shooter.stopMotors()).andThen(Commands.runOnce(() -> s_Indexer.stopRoller())));

        joystickLeft2Button5.onTrue(Commands.runOnce(() -> s_Shooter.setMotorSpeedRPM(50)).andThen(Commands.runOnce(() -> s_Indexer.setMotorSpeedRPM(17))));
        joystickLeft2Button5.onFalse(Commands.runOnce(() -> s_Shooter.stopMotors()).andThen(Commands.runOnce(() -> s_Indexer.stopRoller())));
        ...
        joystickLeft1Button5.onTrue(Commands.runOnce(() -> s_Hood.setMotorSpeedRPM(6))).onFalse(Commands.runOnce(()-> s_Hood.stopHood()));
        // joystickRight2Button10.onTrue(Commands.runOnce(() -> s_Hood.stopHood()));
        joystickLeft1Button3.onTrue(Commands.runOnce(() -> s_Hood.setMotorSpeedRPM(-6))).onFalse(Commands.runOnce(() -> s_Hood.stopHood()));
        // // go to position
        ...
        joystickRight2Button1.onTrue(new startRollers(s_IntakeRoller));
        joystickRight2Button1.onFalse(new stopRollers(s_IntakeRoller));
        //button.onTrue(new lowerLift().andThen(new startRollers()));
        //INTAKE LIFT
        joystickRight2Button5.whileTrue(Commands.runOnce(() -> s_IntakeLift.setMotorSpeedRPM(200))).onFalse(Commands.runOnce(()-> s_IntakeLift.stopLift()));
        ...
        joystickRight2Button3.whileTrue(Commands.runOnce(() -> s_IntakeLift.setMotorSpeedRPM(-200))).onFalse(Commands.runOnce(() -> s_IntakeLift.stopLift()));
        

        // joystickRight1Button7.onTrue(new stopRollers(s_IntakeRoller).andThen(new raiseLift(s_IntakeLift)));
        // joystickRight1Button8.onTrue(new stopRollers(s_IntakeRoller).andThen(new raiseLift(s_IntakeLift)));
        // joystickRight1Button7.onTrue(new lowerLift(s_IntakeLift).andThen(new startRollers(s_IntakeRoller)));
